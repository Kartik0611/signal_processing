...
//if(lhs<4 | lhs<2)                 // It should have been " lhs>4 | lhs< 2 "
if(lhs>4 | lhs<2)
...
select (rhs)
	case 3 then
		//if (lhs==2) 	 [a,b] = callOctave("cheby2",n, rp, w)            // "rp" should be replaced by  "rs"
                      if (lhs==2) 	 [a,b] = callOctave("cheby2",n, rs, w)
		//elseif (lhs==3)  [a,b,c] = callOctave("cheby2",n, rp, w)            // "rp" should be replaced by  "rs"
                      elseif (lhs==3)  [a,b,c] = callOctave("cheby2",n, rs, w)
		//elseif (lhs==4)  [a,b,c,d] = callOctave("cheby2",n, rp, w)          // "rp" should be replaced by  "rs"
                      elseif (lhs==4)  [a,b,c,d] = callOctave("cheby2",n, rs, w)
		end
	case 4 then
		//if (lhs==2) 	 [a,b] = callOctave("cheby2",n, rp, w, varargin(1))  / "rp" should be replaced by  "rs"
                      if (lhs==2) 	 [a,b] = callOctave("cheby2",n, rs, w, varargin(1))
		//elseif (lhs==3)  [a,b,c] = callOctave("cheby2",n, rp, w, varargin(1))     // "rp" should be replaced by  "rs"
		elseif (lhs==3)  [a,b,c] = callOctave("cheby2",n, rs, w, varargin(1))
		//elseif (lhs==4)  [a,b,c,d] = callOctave("cheby2",n, rp, w, varargin(1))   // "rp" should be replaced by  "rs"
		elseif (lhs==4)  [a,b,c,d] = callOctave("cheby2",n, rs, w, varargin(1))
		end
	case 5 then
		//if (lhs==2) 	 [a,b] = callOctave("cheby2",n, rp, rs, w, varargin(1), varargin(2))
                      if (lhs==2) 	 [a,b] = callOctave("cheby2",n,rs, w, varargin(1), varargin(2))
		//elseif (lhs==3)  [a,b,c] = callOctave("cheby2",n, rp, rs, w, varargin(1), varargin(2))
		elseif (lhs==3)  [a,b,c] = callOctave("cheby2",n,rs, w, varargin(1), varargin(2))
		//elseif (lhs==4)  [a,b,c,d] = callOctave("cheby2",n, rp, rs, w, varargin(1), varargin(2))
		elseif (lhs==4)  [a,b,c,d] = callOctave("cheby2",n, rs, w, varargin(1), varargin(2))
		end
	end
endfunction
